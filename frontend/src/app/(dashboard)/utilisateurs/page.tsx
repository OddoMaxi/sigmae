...
const roleColors: Record<string, string> = {
  ...
  agent_impression:    'bg-gray-100 text-gray-700',
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <div>
            <h3 className="font-semibold text-gray-800">Modifier l'utilisateur</h3>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Gestion des comptes et droits d'accès</p>
        </div>
      ...
      {showCreate && (
        <div className="bg-white rounded-xl shadow-sm border border-[#1a5276]/20 p-6">
          <h3 className="font-semibold text-gray-700 mb-4">Créer un utilisateur</h3>
